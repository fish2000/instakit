...
extern "C" void CImage_Register() {
    /*
    CImage_NPY_BOOL::reg = CImage_Functor<NPY_BOOL, bool>(NPY_BOOL);
    CImage_NPY_BYTE::reg = CImage_Functor<NPY_BYTE, char>(NPY_BYTE);
    CImage_NPY_HALF::reg = CImage_Functor<NPY_HALF, npy_half>(NPY_HALF);
    CImage_NPY_SHORT::reg = CImage_Functor<NPY_SHORT, short>(NPY_SHORT);
    CImage_NPY_INT::reg = CImage_Functor<NPY_INT, int>(NPY_INT);
    CImage_NPY_LONG::reg = CImage_Functor<NPY_LONG, long>(NPY_LONG);
    CImage_NPY_LONGLONG::reg = CImage_Functor<NPY_LONGLONG, long long>(NPY_LONGLONG);
    CImage_NPY_UBYTE::reg = CImage_Functor<NPY_UBYTE, unsigned char>(NPY_UBYTE);
    CImage_NPY_USHORT::reg = CImage_Functor<NPY_USHORT, unsigned short>(NPY_USHORT);
    CImage_NPY_UINT::reg = CImage_Functor<NPY_UINT, unsigned int>(NPY_UINT);
    CImage_NPY_ULONG::reg = CImage_Functor<NPY_ULONG, unsigned long>(NPY_ULONG);
    CImage_NPY_ULONGLONG::reg = CImage_Functor<NPY_ULONGLONG, unsigned long long>(NPY_ULONGLONG);
    CImage_NPY_CFLOAT::reg = CImage_Functor<NPY_CFLOAT, std::complex<float>>(NPY_CFLOAT);
    CImage_NPY_CDOUBLE::reg = CImage_Functor<NPY_CDOUBLE, std::complex<double>>(NPY_CDOUBLE);
    CImage_NPY_FLOAT::reg = CImage_Functor<NPY_FLOAT, float>(NPY_FLOAT);
    CImage_NPY_DOUBLE::reg = CImage_Functor<NPY_DOUBLE, double>(NPY_DOUBLE);
    CImage_NPY_CLONGDOUBLE::reg = CImage_Functor<NPY_CLONGDOUBLE, std::complex<long double>>(NPY_CLONGDOUBLE);
    CImage_NPY_LONGDOUBLE::reg = CImage_Functor<NPY_LONGDOUBLE, std::complex<long double>>(NPY_LONGDOUBLE);
    */
}
